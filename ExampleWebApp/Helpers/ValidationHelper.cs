...
namespace ExampleWebApp.Helpers
{
    public static class ValidationHelper
    {
        ...
        public static void CopyErrorsToModelState<T>(this IBizActionStatus status, ModelStateDictionary modelState, T displayDto) 
        {
        ...
        public static void CopyErrorsToModelState(this IBizActionStatus status, ModelStateDictionary modelState)
        {
            if (!status.HasErrors) return;
