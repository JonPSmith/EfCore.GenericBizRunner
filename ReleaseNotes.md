...
- BREAKING CHANGE: Changed the way in which AutoMapper mappings are set up. Please read upgrade notes as this will change your startup and unit testing code.
